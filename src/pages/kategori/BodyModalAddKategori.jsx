...
const BodyModalAddKategori = ({ children, isVisible, onClose, setItem }) => {
  return (
    <div
      ...
      <div
        className={`${
          isVisible
            ...
            : "scale-75 opacity-0"
        } w-[500px] relative text-lg transition-all font-semibold bg-colorTwo dark:bg-colorDarkTwo rounded-md`}
      >
        {/* Button Close Modal */}
        <button
...
export default BodyModalAddKategori;

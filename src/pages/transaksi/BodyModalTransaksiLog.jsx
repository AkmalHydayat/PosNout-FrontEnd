...
const BodyModalTransaksiLog = ({ children, isVisible, onClose }) => {
  return (
    <div
      ...
      <div
        className={`${
          isVisible
            ...
            : "scale-75 opacity-0"
        } w-[800px] relative text-lg transition-all font-semibold bg-colorTwo dark:bg-colorDarkTwo rounded-md`}
      >
        {/* Button Close Modal */}
        <button
